...
import static com.timevale.cat.core.plugin.match.MethodAnnotationMatch.byMethodAnnotationMatch;
...
public class TraceAnnotationStaticActivation extends ClassStaticMethodsEnhancePluginDefine {
    ...
    public static final String TRACE_ANNOTATION_METHOD_INTERCEPTOR = "com.timevale.cat.plugin.toolkit.trace.activation.TraceAnnotationStaticMethodInterceptor";
    public static final String TRACE_ANNOTATION = "com.timevale.cat.toolkit.trace.Trace";
