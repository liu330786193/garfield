...
import com.lyl.garfield.plugin.jdbc.JDBCDriverInterceptor;
...
public abstract class AbstractDriverInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String DRIVER_INTERCEPT_CLASS = "com.lyl.garfield.plugin.jdbc.JDBCDriverInterceptor";
