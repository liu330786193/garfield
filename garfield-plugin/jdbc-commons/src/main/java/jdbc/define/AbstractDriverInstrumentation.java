...
import com.timevale.cat.plugin.jdbc.JDBCDriverInterceptor;
...
public abstract class AbstractDriverInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String DRIVER_INTERCEPT_CLASS = "com.timevale.cat.plugin.jdbc.JDBCDriverInterceptor";
