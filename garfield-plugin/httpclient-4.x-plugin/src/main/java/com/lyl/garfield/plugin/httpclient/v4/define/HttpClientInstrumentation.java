package com.lyl.garfield.plugin.httpclient.v4.define;/*
...
public abstract class HttpClientInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPT_CLASS = "com.lyl.garfield.plugin.httpclient.v4.HttpClientExecuteInterceptor";
