...
import static com.timevale.cat.core.plugin.match.ClassAnnotationMatch.byClassAnnotationMatch;
import static com.timevale.cat.plugin.spring.mvc.commons.Constants.REQUEST_MAPPING_METHOD_INTERCEPTOR;
import static com.timevale.cat.plugin.spring.mvc.commons.Constants.REST_MAPPING_METHOD_INTERCEPTOR;
        ...
        return new ConstructorInterceptPoint[] {
            new ConstructorInterceptPoint() {
                ...
                public String getConstructorInterceptor() {
                    return "com.timevale.cat.plugin.spring.mvc.v4.ControllerConstructorInterceptor";
                }
            }
        };
    }
