...
package com.lyl.garfield.plugin.spring.mvc.v4.define;
...
import static com.lyl.garfield.core.plugin.match.ClassAnnotationMatch.byClassAnnotationMatch;
import static com.lyl.garfield.plugin.spring.mvc.commons.Constants.REQUEST_MAPPING_METHOD_INTERCEPTOR;
import static com.lyl.garfield.plugin.spring.mvc.commons.Constants.REST_MAPPING_METHOD_INTERCEPTOR;
        ...
        return new ConstructorInterceptPoint[] {
            new ConstructorInterceptPoint() {
                ...
                public String getConstructorInterceptor() {
                    return "com.lyl.garfield.plugin.spring.mvc.v4.ControllerConstructorInterceptor";
                }
            }
        };
    }
