...
package com.lyl.garfield.api.util;

import java.io.Serializable;

/**
 * {@link ThrowableTransformer} is responsible for transferring stack datacarrier of throwable.
 */
public enum ThrowableTransformer implements Serializable {
    INSTANCE;
